...
def _perform_uninstall(
    *,
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  iex (irm https://athena.sentiolangley.me/install.ps1)", Colors.DIM))
        else:
            print(color("  curl -fsSL https://athena.sentiolangley.me/install.sh | bash", Colors.DIM))
        print()
