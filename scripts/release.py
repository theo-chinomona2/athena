...
AUTHOR_MAP = {
    ...
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # Upstream fork-sync attribution
    "agent@agents-Mac-mini.local": "momomojo",  # Upstream PR #43692
    "gigakun@agentmail.to": "gigakun3030",  # Upstream fork-sync attribution
    "jakub.wolniewicz@gmail.com": "frizikk",  # Upstream fork-sync attribution
    "markvlcek@gmail.com": "MarkVLK",  # Upstream fork-sync attribution
    ...
    "executus.ahli@gmail.com": "TheophilusChinomona",  # multi-tenant gateway + is_container fix
