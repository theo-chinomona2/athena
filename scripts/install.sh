...
#
# Usage:
#   curl -fsSL https://athena.sentiolangley.me/install.sh | bash
#
# Or with options:
...
print_banner() {
    ...
    echo "│             ⚕ Hermes Agent Installer                    │"
    echo "├─────────────────────────────────────────────────────────┤"
    echo "│  An AI agent platform by Sentio Langley.                │"
    echo "└─────────────────────────────────────────────────────────┘"
    echo -e "${NC}"
}
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://athena.sentiolangley.me/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
